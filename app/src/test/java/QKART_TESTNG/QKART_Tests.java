...
public class QKART_Tests {
    ...
    public void TestCase01(String TC1_Username,@Optional ("abc@123") String TC1_Password) throws InterruptedException {
        Boolean status;
        // Visit the Registration page and register a new user
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
         status = registration.registerUser(TC1_Username, TC1_Username, true);
        ...
        status = login.PerformLogin(lastGeneratedUserName, TC1_Username);
    ...
    public void TestCase02(String TC2_Username, @Optional("abc@123") String TC2_Password) throws InterruptedException {
        Boolean status;
        ...
        assertFalse(status, "Failed to block the re-registertation of existing user");
    ...
    public void TestCase03(String TC3_ProductNameToSearchFor) throws InterruptedException {
       ...
       // Search for the "yonex" product
        ...
        for (WebElement webElement : searchResults) {
            ...
            assertTrue(elementText.toUpperCase().contains(TC3_ProductNameToSearchFor), "Test Results contains un-expected values: "
                    + elementText);
        }
        ...
        assertTrue(searchResults.size()==0," Expected: no results , actual: Results were available");
    ...
    public void TestCase04(String TC4_ProductNameToSearchFor) throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            assertTrue(result.verifySizeChartExists(), "Failed to validate the presence of size chart");
                ...
                // Open the size chart
                assertTrue(result.openSizechart(),"Failed to open the size chart");
               // Verify if the size chart contents matches the expected values
                ...
                assertTrue(status, "Failed to close the sizechart");
        }
    ...
    public void TestCase05(String TC5_ProductNameToSearchFor,String TC5_ProductNameToSearchFor2,String TC5_AddressDetails) throws InterruptedException {
       ...
       // Go to the Register page
        ...
        assertTrue(status, "Failed to register a user");
        ...
        assertTrue(driver.getCurrentUrl().endsWith("/checkout"),"Failed to navigate to checkout page");
        Thread.sleep(3000);
        ...
        assertTrue(status, "Failed to naviagte to order sucesses page");
    ...
    public void TestCase06(String TC6_ProductNameToSearch1,String TC6_ProductNameToSearch2) throws InterruptedException {
       ...
       // Thread.sleep(3000);
        ...
        status = driver.getCurrentUrl().endsWith("/thanks");
        assertTrue(status, "Failed to navigate to thanks page");
        homePage.navigateToHome();
        homePage.PerformLogout();
    }
    ...
    public void TestCase07(String TC7_ListOfProductsToAddToCart) throws InterruptedException {
        ...
        List<String> expectedResult =
                Arrays.asList("Stylecon 9 Seater RHS Sofa Set ", "Stylecon 9 Seater RHS Sofa Set ");
        ...
        String[] productName = TC7_ListOfProductsToAddToCart.split(";", 2);

        homePage.navigateToHome();
        status = homePage.searchForProduct(productName[0]);
        homePage.addProductToCart("Stylecon 9 Seater RHS Sofa Set ");

        status = homePage.searchForProduct(productName[1]);
        homePage.addProductToCart("Xtend Smart Watch");
        ...
        assertTrue(status, "Failed to verify that cart contents are persisted after logout");
    ...
    public void TestCase08(String TC8_ProductName,int TC8_Qty) throws InterruptedException {
        ...
        homePage.changeProductQuantityinCart("Stylecon 9 Seater RHS Sofa Set ", TC8_Qty);
        ...
        assertTrue(status, "Failed to verify InsufficientBlance message");
    }
    ...
    public void TestCase09() throws InterruptedException {
        ...
        status = homePage.verifyCartContents(expectedResult);
        assertTrue(status, "Failed to verify the product over multiple tabs");
        driver.close();
    ...
    public void TestCase10() throws InterruptedException {
        ...
        assertTrue(status, "Failed to verify new tab opened has Privacy Policy page heading ");
        ...
        assertTrue(status, "Failed to verify new tab opened has Terms Of Service page heading");
    ...
    public void TestCase11(String TC11_ContactusUserName,String TC11_ContactUsEmail,String TC11_QueryContent) throws InterruptedException {
        ...
        assertTrue(contactUs.isEnabled(), "Failed to verify contact us option");
        contactUs.click();
    ...
    public void TestCase12(String TC12_ProductNameToSearch,String TC12_AddresstoAdd) throws InterruptedException {
        ...
        assertTrue(status, "Failed Verify that Advertisement 1 is clickable");
        ...
        status = !driver.getCurrentUrl().equals(currentURL);
        assertTrue(status, "Failed Verify that Advertisement 2 is clickable");
